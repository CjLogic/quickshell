        ...
        Rectangle { // Header background
            ...
            RowLayout { // Header content
                ...
                StyledText {
                    ...
                    text: root.completed ? Translation.tr("Thought") : (Translation.tr("Thinking") + dots)
                }
                ...
                Timer {
                    ...
                    repeat: true
                    onTriggered: {
                        thinkBlockTitleBarRowLayout.parent.dots = (thinkBlockTitleBarRowLayout.parent.dots + ".").slice(-3)
                        if (thinkBlockTitleBarRowLayout.parent.dots.length === 0) {
                            thinkBlockTitleBarRowLayout.parent.dots = "."
                        }
                    }
                }
