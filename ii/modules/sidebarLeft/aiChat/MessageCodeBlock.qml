                    ...
                    TextArea { // Code
                        ...
                        Menu { // Right-click context menu
                            ...
                            MenuItem {
                                ...
                                enabled: codeTextArea.selectedText && codeTextArea.selectedText.length > 0
                                onTriggered: codeTextArea.copy()
                            }
                            MenuItem {
                                text: Translation.tr("Select all")
                                onTriggered: codeTextArea.selectAll()
                            }
                            MenuSeparator {}
                            MenuItem {
                                text: Translation.tr("Copy all (code)")
                                onTriggered: Quickshell.clipboardText = codeTextArea.text
                            }
                        }
                        ...
                        MouseArea {
                            ...
                            onPressed: (mouse) => {
                                if (mouse.button === Qt.RightButton) {
                                    codeContextMenu.x = mouse.x
                                    codeContextMenu.y = mouse.y
                                    codeContextMenu.open()
                                    mouse.accepted = true
                                }
                            }
                        }
