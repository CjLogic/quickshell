        ...
        delegate: TextArea {
            ...
            Menu { // Right-click context menu
                ...
                MenuItem {
                    ...
                    enabled: textArea.selectedText && textArea.selectedText.length > 0
                ...
                MenuSeparator {}
                MenuItem {
                    text: Translation.tr("Copy all (message)")
                    onTriggered: Quickshell.clipboardText = textArea.text
                }
            }

            MouseArea { // Hover + right-click
                anchors.fill: parent
                acceptedButtons: Qt.RightButton // Allow right-click without blocking left-drag selection
                hoverEnabled: true
